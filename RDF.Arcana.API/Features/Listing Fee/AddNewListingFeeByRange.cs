...
//[Route("api/ListingFeeByRange"), ApiController]
//public class AddNewListingFeeByRange : ControllerBase
//{
//    private readonly IMediator _mediator;
//    private readonly IValidator<AddNewListingFeeByRangeCommand> _validator;

//    public AddNewListingFeeByRange(IMediator mediator, IValidator<AddNewListingFeeByRangeCommand> validator)
//    {
//        _mediator = mediator;
//        _validator = validator;
//    }

//    [HttpPost("AddNewListingFeeByRange")]
//    public async Task<IActionResult> AddNewListingFeeRequest([FromBody] AddNewListingFeeByRangeCommand command)
//    {
//        try
//        {
...
//    public class AddNewListingFeeByRangeCommand : IRequest<Result>
//    {
//        public int ClientId { get; set; }
//        public int RequestedBy { get; set; }
//        public decimal Total { get; set; }
//        public ICollection<ListingFeeItems> ListingItems { get; set; }

//        public class ListingFeeItems
//        {
...
//    public class AddNewListingFeeByRangeFeeResult
//    {
...
//    public class Handler : IRequestHandler<AddNewListingFeeByRangeCommand, Result>
//    {
...
//        public async Task<Result> Handle(AddNewListingFeeByRangeCommand request, CancellationToken cancellationToken)
//        {
...
//            //{
//            //    return BadRequest("No approver found for the given range.");
//            //}
...
//                Level = 1, // Assuming level 1 for the example, you can adjust based on your logic
//            };
...
//            var result = new AddNewListingFeeByRangeFeeResult
//            {
