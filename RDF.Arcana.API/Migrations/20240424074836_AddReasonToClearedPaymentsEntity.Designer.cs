...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240424074836_AddReasonToClearedPaymentsEntity")]
    partial class AddReasonToClearedPaymentsEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(859),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(862)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(866),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(867)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(870),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(889)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(892),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(893)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(895),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(896)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(1033),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(1049),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.PaymentRecords", b =>
                {
                    ...
                    b.Property<int?>("ClearedPaymentsId")
                        .HasColumnType("int")
                        .HasColumnName("cleared_payments_id");
                    ...
                    b.HasIndex("ClearedPaymentsId")
                        .HasDatabaseName("ix_payment_records_cleared_payments_id");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.PaymentTransaction", b =>
                {
                    ...
                    b.HasIndex("ClearedPaymentsId")
                        .HasDatabaseName("ix_payment_transactions_cleared_payments_id");

                    b.HasIndex("PaymentRecordId")
                        .HasDatabaseName("ix_payment_transactions_payment_record_id");

                    b.HasIndex("TransactionsId")
                        .HasDatabaseName("ix_payment_transactions_transactions_id");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(953),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(980),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(983),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 78, DateTimeKind.Local).AddTicks(4534),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$S8zGtEVzGrHmnuVGdFQhHew3xBT4k7Pn2O/vRu7pDp1yyIfvsC1Se",
                            UpdatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 78, DateTimeKind.Local).AddTicks(4554),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 4, 24, 15, 48, 32, 582, DateTimeKind.Local).AddTicks(477),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.PaymentRecords", b =>
                {
                    ...
                    b.HasOne("RDF.Arcana.API.Domain.ClearedPayments", "ClearedPayments")
                        .WithMany()
                        .HasForeignKey("ClearedPaymentsId")
                        .HasConstraintName("fk_payment_records_cleared_payments_cleared_payments_id");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.PaymentTransaction", b =>
                {
                    ...
                    b.HasOne("RDF.Arcana.API.Domain.ClearedPayments", null)
                        .WithMany("PaymentTransactions")
                        .HasForeignKey("ClearedPaymentsId")
                        .HasConstraintName("fk_payment_transactions_cleared_payments_cleared_payments_id");
                    ...
                    b.HasOne("RDF.Arcana.API.Domain.Transactions", "Transactions")
                        .WithMany()
                        .HasForeignKey("TransactionsId")
                        .HasConstraintName("fk_payment_transactions_transactions_transactions_id");
