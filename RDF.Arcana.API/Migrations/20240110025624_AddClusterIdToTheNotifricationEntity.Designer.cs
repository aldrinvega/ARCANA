...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240110025624_AddClusterIdToTheNotifricationEntity")]
    partial class AddClusterIdToTheNotifricationEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2869),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2872)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2881),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2883)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2888),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2890)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2898),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2951)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2960),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2963)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(3493),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(3504),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(3102),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(3233),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(3244),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 23, 169, DateTimeKind.Local).AddTicks(4279),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$NqRzf4MIKNpiTqSeJiz8f.Nv9e/VerYVuVanJwLJGDEOJv1qe1eze",
                            UpdatedAt = new DateTime(2024, 1, 10, 10, 56, 23, 169, DateTimeKind.Local).AddTicks(4379),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 1, 10, 10, 56, 24, 154, DateTimeKind.Local).AddTicks(2626),
                            IsActive = true,
