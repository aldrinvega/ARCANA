...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240216031931_AddMobileNumberonUserEntity")]
    partial class AddMobileNumberonUserEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(403),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(403)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(406),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(407)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(408),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(408)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(409),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(423)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(425),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(426)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(510),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(514),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(460),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(477),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(478),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 569, DateTimeKind.Local).AddTicks(3981),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$n8CUbyQBmW88foI3Iwzede52ptRAmepTnuCvb2eT32evkiC8o1G6e",
                            UpdatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 569, DateTimeKind.Local).AddTicks(3998),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 16, 11, 19, 31, 687, DateTimeKind.Local).AddTicks(299),
                            IsActive = true,
