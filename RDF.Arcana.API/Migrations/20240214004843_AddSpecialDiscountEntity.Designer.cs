...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240214004843_AddSpecialDiscountEntity")]
    partial class AddSpecialDiscountEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(877),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(877)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(881),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(882)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(883),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(883)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(884),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(895)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(897),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(897)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(983),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(988),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(930),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(951),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(953),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 108, DateTimeKind.Local).AddTicks(5984),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$Src.FXy1WR156gfP0qGu9.aGR3.nE30edv3cWfIV5QLnMJ1rLCBDa",
                            UpdatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 108, DateTimeKind.Local).AddTicks(5998),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 14, 8, 48, 43, 225, DateTimeKind.Local).AddTicks(792),
                            IsActive = true,
