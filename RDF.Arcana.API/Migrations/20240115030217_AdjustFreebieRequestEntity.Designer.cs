...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240115030217_AdjustFreebieRequestEntity")]
    partial class AdjustFreebieRequestEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9330),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9332)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9336),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9337)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9340),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9340)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9342),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9360)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9362),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9363)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9491),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9496),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9416),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9449),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9452),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 15, 691, DateTimeKind.Local).AddTicks(5898),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$R/1TdTyZkzyMFPcAyPA5JutI/N3PIssZdP1rxsIIX2X0rJ9bIeeqa",
                            UpdatedAt = new DateTime(2024, 1, 15, 11, 2, 15, 691, DateTimeKind.Local).AddTicks(5936),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 1, 15, 11, 2, 16, 49, DateTimeKind.Local).AddTicks(9183),
                            IsActive = true,
