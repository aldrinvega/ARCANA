...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240202022927_AdProceModeDescriptionOnPriceModeEntity")]
    partial class AdProceModeDescriptionOnPriceModeEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7845),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7849)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7860),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7863)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7870),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7881)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7896),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7982)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7995),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(8003)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(8486),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(8499),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(8253),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(8336),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(8356),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 25, 851, DateTimeKind.Local).AddTicks(8243),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$e9tpvxPFzLoQQA4XmHkPxeNJH9f.YU8cRsVcBkoxxAVMDFOFxomgi",
                            UpdatedAt = new DateTime(2024, 2, 2, 10, 29, 25, 851, DateTimeKind.Local).AddTicks(8256),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 10, 29, 26, 224, DateTimeKind.Local).AddTicks(7408),
                            IsActive = true,
