...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240619050044_RemoveOnlinePaymentTable")]
    partial class RemoveOnlinePaymentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3205),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3206)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3223),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3223)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3225),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3280)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3281),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3282)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3283),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3284)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3930),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3942),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3452),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3793),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(3795),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 39, 862, DateTimeKind.Local).AddTicks(7855),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$FEh9awJSqOOSODatp7wNPOLX5p3dFxVdGLZ9/GPMB27jWcD4XI40.",
                            UpdatedAt = new DateTime(2024, 6, 19, 13, 0, 39, 862, DateTimeKind.Local).AddTicks(7880),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 6, 19, 13, 0, 40, 192, DateTimeKind.Local).AddTicks(2575),
                            IsActive = true,
