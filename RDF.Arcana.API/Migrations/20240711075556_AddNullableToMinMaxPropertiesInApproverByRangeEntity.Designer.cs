...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240711075556_AddNullableToMinMaxPropertiesInApproverByRangeEntity")]
    partial class AddNullableToMinMaxPropertiesInApproverByRangeEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8871),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8875)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8882),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8882)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8886),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8904)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8909),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8910)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8912),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8912)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(9054),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(9063),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8989),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(9002),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(9005),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 52, 468, DateTimeKind.Local).AddTicks(3343),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$VnIV/EDDiLl1ie91EqWlOupF/InciNtKHs5k7iTrtrG45SHs.oJAO",
                            UpdatedAt = new DateTime(2024, 7, 11, 15, 55, 52, 468, DateTimeKind.Local).AddTicks(3364),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 7, 11, 15, 55, 53, 667, DateTimeKind.Local).AddTicks(8749),
                            IsActive = true,
