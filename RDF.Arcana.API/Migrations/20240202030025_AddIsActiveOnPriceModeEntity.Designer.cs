...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240202030025_AddIsActiveOnPriceModeEntity")]
    partial class AddIsActiveOnPriceModeEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2338),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2340)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2345),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2346)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2349),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2350)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2353),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2374)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2377),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2378)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2525),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2532),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2441),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2480),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2484),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 433, DateTimeKind.Local).AddTicks(5213),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$z5E03fJGzvOwaH7qvon5teqtHvfDI3mgF5Nd2wW/WHrIsCOYE29cS",
                            UpdatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 433, DateTimeKind.Local).AddTicks(5240),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 2, 11, 0, 24, 738, DateTimeKind.Local).AddTicks(2210),
                            IsActive = true,
