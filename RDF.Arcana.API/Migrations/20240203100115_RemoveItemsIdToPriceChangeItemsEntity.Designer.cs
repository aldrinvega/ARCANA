...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240203100115_RemoveItemsIdToPriceChangeItemsEntity")]
    partial class RemoveItemsIdToPriceChangeItemsEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3028),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3029)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3033),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3033)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3036),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3037)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3038),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3059)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3061),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3062)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3179),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3183),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3111),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3137),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(3139),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 85, DateTimeKind.Local).AddTicks(6199),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$P0RdDKp0WHd5Xwz2uYa97u70Z1N7IFmKM1CFmATzJv.Tfk6RSIbwy",
                            UpdatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 85, DateTimeKind.Local).AddTicks(6312),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 2, 3, 18, 1, 14, 418, DateTimeKind.Local).AddTicks(2885),
                            IsActive = true,
