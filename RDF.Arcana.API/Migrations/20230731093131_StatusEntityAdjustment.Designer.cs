...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20230731093131_StatusEntityAdjustment")]
    partial class StatusEntityAdjustment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Client", b =>
                {
                    ...
                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_clients_status_id");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Client", b =>
                {
                    ...
                    b.HasOne("RDF.Arcana.API.Domain.Status", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .HasConstraintName("fk_clients_status_status_id");
