...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20231227005851_AddMerchandisingAllowanceEntity")]
    partial class AddMerchandisingAllowanceEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6370),
                            IsActive = true,
                            UpdatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6371)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6375),
                            IsActive = true,
                            UpdatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6375)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6377),
                            IsActive = true,
                            UpdatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6377)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6378),
                            IsActive = true,
                            UpdatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6379)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6392),
                            IsActive = true,
                            UpdatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6392)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.MerchandisingAllowance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_merchandising_allowances");

                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_merchandising_allowances_added_by");

                    b.HasIndex("ListingFeeId")
                        .IsUnique()
                        .HasDatabaseName("ix_merchandising_allowances_listing_fee_id");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_merchandising_allowances_modified_by");

                    b.HasIndex("RequestId")
                        .IsUnique()
                        .HasDatabaseName("ix_merchandising_allowances_request_id");

                    b.ToTable("merchandising_allowances", (string)null);
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6458),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6461),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6424),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6430),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6439),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 50, 868, DateTimeKind.Local).AddTicks(7129),
                            Fullname = "Admin",
                            IsActive = false,
                            IsPasswordChanged = false,
                            Password = "$2a$11$od0sNexUaWbusHJBbPEuHuHzUnQdkRNMuRYaWj4/uda7KjI2Hb14.",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserRolesId = 1,
                            Username = "admin"
                        });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 8, 58, 51, 110, DateTimeKind.Local).AddTicks(6283),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.MerchandisingAllowance", b =>
                {
                    b.HasOne("RDF.Arcana.API.Domain.User", "AddedByUser")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_merchandising_allowances_users_added_by_user_id");

                    b.HasOne("RDF.Arcana.API.Domain.ListingFee", "ListingFee")
                        .WithOne("MerchandisingAllowance")
                        .HasForeignKey("RDF.Arcana.API.Domain.MerchandisingAllowance", "ListingFeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_merchandising_allowances_listing_fees_listing_fee_id");

                    b.HasOne("RDF.Arcana.API.Domain.User", "ModifiedUser")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .HasConstraintName("fk_merchandising_allowances_users_modified_user_id");

                    b.HasOne("RDF.Arcana.API.Domain.Request", "Request")
                        .WithOne("MerchandisingAllowance")
                        .HasForeignKey("RDF.Arcana.API.Domain.MerchandisingAllowance", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_merchandising_allowances_requests_request_id");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ListingFee", b =>
                {
                    ...
                    b.Navigation("MerchandisingAllowance");
                });
