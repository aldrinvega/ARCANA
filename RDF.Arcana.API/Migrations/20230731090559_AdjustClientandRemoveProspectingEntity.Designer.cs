...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20230731090559_AdjustClientandRemoveProspectingEntity")]
    partial class AdjustClientandRemoveProspectingEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Client", b =>
                {
                    ...
                    b.HasIndex("ApprovedBy")
                        .IsUnique()
                        .HasDatabaseName("ix_clients_approved_by");
                    ...
                    b.HasIndex("RegistrationStatusId")
                        .HasDatabaseName("ix_clients_registration_status_id");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.RegistrationStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_registration_status");

                    b.HasIndex("AddedBy")
                        .IsUnique()
                        .HasDatabaseName("ix_registration_status_added_by");

                    b.HasIndex("ModifiedBy")
                        .IsUnique()
                        .HasDatabaseName("ix_registration_status_modified_by");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Client", b =>
                {
                    ...
                    b.HasOne("RDF.Arcana.API.Domain.User", "ApprovedByUser")
                        .WithOne()
                        .HasForeignKey("RDF.Arcana.API.Domain.Client", "ApprovedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_clients_users_approved_by_user_id");
                    ...
                    b.HasOne("RDF.Arcana.API.Domain.RegistrationStatus", "RegistrationStatus")
                        .WithMany()
                        .HasForeignKey("RegistrationStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_clients_registration_status_registration_status_id");
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.RegistrationStatus", b =>
                {
                    b.HasOne("RDF.Arcana.API.Domain.User", "AddedByUser")
                        .WithOne()
                        .HasForeignKey("RDF.Arcana.API.Domain.RegistrationStatus", "AddedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_registration_status_users_added_by_user_id");

                    b.HasOne("RDF.Arcana.API.Domain.User", "ModifiedByUser")
                        .WithOne()
                        .HasForeignKey("RDF.Arcana.API.Domain.RegistrationStatus", "ModifiedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_registration_status_users_modified_by_user_id");
