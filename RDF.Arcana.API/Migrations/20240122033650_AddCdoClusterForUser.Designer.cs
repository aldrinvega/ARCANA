...
namespace RDF.Arcana.API.Migrations
{
    ...
    [Migration("20240122033650_AddCdoClusterForUser")]
    partial class AddCdoClusterForUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.BookingCoverages", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddedBy = 1,
                            BookingCoverage = "F1",
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8158),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8161)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            BookingCoverage = "F2",
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8182),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8184)
                        },
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            BookingCoverage = "F3",
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8189),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8193)
                        },
                        new
                        {
                            Id = 4,
                            AddedBy = 1,
                            BookingCoverage = "F4",
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8198),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8260)
                        },
                        new
                        {
                            Id = 5,
                            AddedBy = 1,
                            BookingCoverage = "F5",
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8265),
                            IsActive = true,
                            UpdatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8267)
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.ModeOfPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8609),
                            IsActive = true,
                            Payment = "Cash",
                        ...
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8636),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.Terms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8419),
                            IsActive = true,
                            TermType = "COD",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8480),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            AddedBy = 1,
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(8485),
                            IsActive = true,
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 48, 652, DateTimeKind.Local).AddTicks(9220),
                            Fullname = "Admin",
                            IsActive = true,
                            IsPasswordChanged = false,
                            Password = "$2a$11$P68HUY03ZMckLGP2BDTi0e5ZInsjehhjdfJTgl/je7XZvAxJ3ql/G",
                            UpdatedAt = new DateTime(2024, 1, 22, 11, 36, 48, 652, DateTimeKind.Local).AddTicks(9299),
                            UserRolesId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("RDF.Arcana.API.Domain.UserRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 1, 22, 11, 36, 49, 160, DateTimeKind.Local).AddTicks(7880),
                            IsActive = true,
